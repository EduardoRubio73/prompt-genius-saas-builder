...
import { ChevronDown, ChevronUp, Sparkles, FileCode, Layers, CheckCircle, Clock, Eye } from "lucide-react";
...
export default function HistoryPage() {
  ...
  const [modeFilter, setModeFilter] = useState<"all" | "prompt" | "saas" | "misto">("all");
  ...
  return (
    ...
    >
      ...
      <section className="mb-6 flex items-center gap-2 flex-wrap">
        {(["all", "prompt", "saas", "misto"] as const).map((m) => (
          <button
            key={m}
